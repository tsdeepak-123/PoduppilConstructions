...
const{handleLabourAdding,handleLabourDetails,handleAttendance,salarycalculationoflabour,handleLabourById,labourAttendanceById,salarycalculation,handleAttendanceList,handleLabourAdvance, handleLabourHIstory, labourAttendanceEdit, handleAllLabourHIstory}=require('../controllers/Admin/LabourController')
const{handleStaffAdding,handleStaffDetails,handleAttendanceofStaff,salarycalculationofStaff,handleStaffById,handleAttendanceListofStaff,handleStaffAdvance,salarycalculationforStaff, stafffAttendanceEdit, handleAllStaffHIstory}=require('../controllers/Admin/StaffController')
